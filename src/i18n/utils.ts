...
export type TranslationsFunction = (key: keyof TranslationObject[DefaultLang]) => string;
...
export const useTranslations = (lang: Lang): ((key: keyof TranslationObject[DefaultLang]) => string) =>
